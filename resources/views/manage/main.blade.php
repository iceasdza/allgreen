<div class="container text-center" style="color:black;font-size:50px">Main Distrivution Board.</div>
<hr>
  ...
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <form method="POST" enctype="multipart/form-data" action="main-upload" style="padding-right:200px;padding-left:200px">
            ...
            <div class="col-sm-6 col-md-3">
                <div class="thumbnail" style="text-align: center">
                    ...
                    <div class="caption">
                        ...
                        <form method="POST" enctype="multipart/form-data" action="main-delete">
